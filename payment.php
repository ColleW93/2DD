    ...
    $('#payment-form').bootstrapValidator({
        ...
        fields: {
          Fornavn: {
                validators: {
                    notEmpty: {
                        message: 'The Fornavn is required and cannot be empty'
                    },
          stringLength: {
                        min: 6,
                        max: 96,
                        message: 'The Fornavn must be more than 6 and less than 96 characters long'
                    }
                }
            },
          Efternavn: {
                validators: {
                    notEmpty: {
                        message: 'The Efternavn is required and cannot be empty'
                    },
          stringLength: {
                        min: 6,
                        max: 96,
                        message: 'The Efternavn must be more than 6 and less than 96 characters long'
                    }
                }
            },
          ...
          nummer: {
                validators: {
                    notEmpty: {
                        message: 'The nummer is required and cannot be empty'
                    },
          stringLength: {
                        min: 6,
                        max: 96,
                        message: 'The nummer must be more than 6 and less than 96 characters long'
                    }
                }
            },
		...
		selector: '#cvv',
                validators: {
                    notEmpty: {
                        message: 'CVV er påkrævet'
                    },
					cvv: {
                        message: 'Ugyldigt CVV',
...
<script type="text/javascript">
            ...
            Stripe.setPublishableKey('pk_test_uWYohL9FRpNOS7XyNJlWBqX9');
...
<body>
<form action="index.php" method="POST" id="payment-form" class="form-horizontal">
...
?>
  ...
  <!-- Form Name -->
  <legend>FAKTURERINGSINFORMATION</legend>
  
  <!-- Fornavn -->
  <div class="form-group">
    <label class="col-sm-4 control-label" for="textinput">Fornavn</label>
    <div class="col-sm-6">
      <input type="text" name=fFornavn" placeholder="Fornavn" class="address form-control">
    </div>
  </div>

  <!-- Efternavn -->
  <div class="form-group">
    <label class="col-sm-4 control-label" for="textinput">Efternavn</label>
    <div class="col-sm-6">
      <input type="text" name="efternavn" placeholder="Efternavn" class="address form-control">
    </div>
  </div>

  <!-- Telefonnummer -->
  <div class="form-group">
    <label class="col-sm-4 control-label" for="textinput">Telefonnummer</label>
    <div class="col-sm-6">
      <input type="text" name="telefonnummer" placeholder="Telefonnummer" class="address form-control">
    </div>
  </div>
