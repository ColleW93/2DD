					...
					<div id="maingreet">
						<div class="carousel-inner">
							<div class="item active">
								<div class="col-sm-9">
									<h1><Span>BESTILLING</Span></h1>

									<ul>
										<ol>
											<p id="list"> 1. KØB trin-for-trin. <br> 2. Find den ønskede vare. <br> 3. Kom varen i indkøbskurv ved at klikke på symbolet "Læg i kurv". <br> 4. Derefter kan du fortsætte din søgning, hvis der skal handles mere.

									<p>Fortryder du indholdet, eller ønsker du at foretage rettelser og fx ændre antallet af varer, kan du henholdsvis slette på slet-knappen eller rette i boxen med antal. 'Opdater kurv', hvis du vil se prisen efter ændringerne. Herefter går du til kassen. Skærmbilledet hedder "Gå til kassen". 
									På næste skærmbillede vælger du betalingsform og forsendelse. Herefter skal du indtaste kundeoplysninger og eventuel anden leveringsadresse. Klik "Forsæt". Bekræft ordre - opsamling af bestilling og en data du har indtastet. Din bestilling bliver først afsendt, når du klikker på "Afslut køb". Hvis du inden da forlader siden, er købstransaktionen ikke gennemført. Systemet sender dig straks en ordrebekræftelse på den e-mail du har opgivet under kundeoplysninger. Når din bestilling er ekspederet, får du igen en elektronisk meddelelse.</p>
								</div>
							</div>							
						</div>
					</div>				
