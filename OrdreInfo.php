				...
				<div class="lagercontainer" >
						<h2 class="ltitle text-center">Ordrer</h2>
							<?php
								...
								$ordreInfo = mysqli_query($dbc, "SELECT * FROM ordredetaljer WHERE ordreID='$ordreID'");
								
							?>


				            <?php
				               while ($row = mysqli_fetch_array($ordreInfo))
				                {
				                   ...
				                   <span style="font-weight: bold;">Ordre ID: </span>'.$row['ordreID'].'
				                   <ul><span style="font-weight: bold;">Produkt Navn: </span>'. $row['odreProduktNavn'].'</ul>'.'
				                   <ul><span style="font-weight: bold;">Produkter ID: </span>'. $row['produktID'].'</ul>'.'
				                   <ul><span style="font-weight: bold;">Antal: </span>'. $row['ordreProduktAntal'].'</ul>'.'
				                   <ul><span style="font-weight: bold;">Pris: </span>'. $row['ordreProduktPris'].' kr.-</ul><ol style="margin-left:-40px;">'.'
				                   	<div class="choose">
