				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						<h2 class="title text-center">Sortiment</h2>
							...
							<?php
								$query4 = mysqli_query($dbc, "SELECT * FROM products WHERE KatID = 4");				
							?>
						    ...
						    <div class="col-md-4" id="produktliste">  
			                    <form method="post" action="ProduktInfo.php?action=add&id=<?php echo $row["ID"]; ?>">  
	                                ...
	                                <input type="submit" id="produktlæs" name="info" class="btn btn-success" value="Læs Mere" href="ProduktInfo.php" />  
	                                <input id="produktkøb" type="submit" name="add_to_cart" class="btn btn-success" value="Tilføj" href="Kurv.php"/>
	                                </div> 
			                    </form>  
			                </div>					                
			                <?php
