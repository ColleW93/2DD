					...
					<div id="maingreet">
						<div class="carousel-inner">
							<div class="item active">
								<div class="col-sm-9">
									<h1><Span>LEVERING</Span></h1>


									<p>2daydesign.dk sørger for levering med Post Danmark (med mindre andet angives) til modtager på den dato der er ønsket i bestillingen. Rettidig levering forudsætter dog at Post Danmark overholder dag-til-dag levering. Såfremt der opstår forsinkelser hos Post Danmark, vil dette tilsvarende forsinke leverancen i forhold til den ønskede leveringsdato. Post Danmarks kvalitetsmål omkring leveringssikkerhed er minimum 97% for brevpakker og minimum 99% for pakkepost. Bemærk dog at disse procentsatser er gennemsnitlige, og kan dække over store lokale og tidsbegrænsede variationer. 2daydesign.dk kan ikke drages til ansvar for forsinkelser hos Post Danmark. I tilfælde af meget forsinkede (adskillige dage) eller decideret udeblevne leverancer, fremsender 2daydesign.dk naturligvis en ny leverance uden beregning. 
									<br><br>
									...
									<br><br>
									Der leveres ikke til Færøerne, Grønland og udlandet.</p>
								</div>
							</div>							
						</div>
					</div>				
