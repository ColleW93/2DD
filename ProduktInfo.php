			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						<h2 class="title text-center">Vare</h2>

							<?php

								$ProductID = $_POST['ID'];
								//$infoquery2 = mysqli_query($dbc, "SELECT * FROM products WHERE ID = '$_POST[ID]'");
								$infoquery = mysqli_query($dbc, "SELECT * FROM products WHERE ID = '$ProductID'");								
							?>
									...
									<!--product-details-->
										<div class="col-sm-5">
											<div class="view-product">
												<?php echo '<img src="data:image/jpeg;base64,'.base64_encode( $row['Billede'] ).'" height="300px" width="300px"/> '?>
											</div>
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								<h4 class="text-info" style="font-size: 40px;"><?php echo $row["Navn"]; ?></h4>
								<span>
									<span class="text-success" style="font-size: 20px;"><?php echo $row["Pris"]; ?> Kr,-</span>
									<br>
									<label>Antal:</label>
								...
								<p class="text-muted" style="font-size: 20px; margin-top: 20px;"><?php echo $row["Beskrivelse"]; ?></p>
