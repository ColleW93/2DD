					...
					<div id="maingreet">
						<div class="carousel-inner">
							<div class="item active">
								<div class="col-sm-9">
									<h1><Span>BETALING</Span></h1>

									<p>2daydesign.dk modtager betaling på 3 måder:</p>
									<ul>
										<ol>
											<p id="list"> 
											1. Dankort <img id ="Dankort" src="img/Dankort.gif"> <br> <br>
											2. Mobilepay || 53 35 29 44 <img id="Mobilepay" src="img/Mobilepay.png"> <br> <br>
											3. Bankoverførelse || kontonr. 1345 4386556925 Nordea <img src="img/Nordea.png" id="Nordea"> <br> 			
								</div>
							</div>							
						</div>
					</div>				
